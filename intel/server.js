/**
 * GECKO Intelligence Layer — gecko-intel
 *
...
const WIKIDATA_UA = 'GECKO-Intel/1.0 (https://geckoai.live; ontology engine)';
...
app.get('/resolve', async (req, res) => {
  ...
  try {
    ...
    res.json({
      ...
      links: result.links,
      entity: { type, id },
      source: 'GECKO Intelligence Layer',
...
async function boot() {
  console.log('[INTEL] GECKO Intelligence Layer starting...');
  await loadSanctions();
