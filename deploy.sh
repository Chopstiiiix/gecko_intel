#!/bin/bash
# =========================================================
#  GECKO — Deploy Cycle Script
#  Git → SSH → Docker Rebuild → Live
# =========================================================
#
#  Usage (from your local gecko project directory):
...
echo -e "${CYAN}╔══════════════════════════════════════════╗${NC}"
echo -e "${CYAN}║     GECKO DEPLOYMENT CYCLE              ║${NC}"
...
COMMIT_MSG="${1:-deploy: update gecko production $(date '+%Y-%m-%d %H:%M')}"
...
echo -e "${CYAN}║     https://gecko.inspire-edge.net is live         ║${NC}"
echo -e "${CYAN}╚══════════════════════════════════════════╝${NC}"
