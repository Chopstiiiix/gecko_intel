...
const TYPE_COLORS: Record<string, string> = {
  ...
  person: '#8FA376', country: '#5F8443', event: '#D29B3B', sanction: '#B0492F',
  ip: '#D29B3B',
};
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-3 border-b border-[var(--border-primary)] bg-[var(--gold-primary)]/5 relative z-20">
          <div className="flex items-center gap-3">
            <div className="w-1.5 h-1.5 bg-[var(--gold-primary)] animate-gecko-pulse shadow-[0_0_8px_var(--gold-primary)]" />
            <span className="text-[12px] font-mono font-bold tracking-[0.2em] text-[var(--gold-primary)]">[ GECKO // ENTITY INTEL ]</span>
        ...
        {entity ? (
          ...
          <div className="px-6 py-3 border-b border-[var(--border-primary)] flex items-center gap-3 bg-black/20 relative z-20">
            <Network className="w-4 h-4 text-[var(--gold-primary)]/50 animate-gecko-pulse" />
