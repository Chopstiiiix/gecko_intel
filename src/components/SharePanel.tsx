...
export default function SharePanel({ mapView, activeLayers, mouseCoords }: SharePanelProps) {
  ...
  const generateShareUrl = useCallback(() => {
    ...
    const base = typeof window !== 'undefined' ? window.location.origin : 'https://gecko.vercel.app';
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-12 right-0 w-72 glass-panel p-4 pointer-events-auto gecko-glow z-[300]"
          >
