...
/**
 * Thin proxy to the GECKO Intelligence Layer (gecko-intel).
 *
 * In Docker: fetches from http://gecko-intel:4000/resolve
...
export async function GET(req: Request) {
  ...
  try {
    ...
    console.error('[GECKO] Intel proxy error:', e instanceof Error ? e.message : e);
    return NextResponse.json(
