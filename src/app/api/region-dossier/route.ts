  ...
  try {
    ...
    const geoRes = await fetch(
      `https://nominatim.openstreetmap.org/reverse?lat=${lat}&lon=${lng}&format=json&zoom=5&addressdetails=1`,
      {
        ...
        headers: { 'User-Agent': 'GeckoIntelPlatform/1.0' },
      }
    );
    ...
    const [countryResult, wikiResult, hosResult] = await Promise.allSettled([
      ...
      (async () => {
        ...
        } catch (e) { console.warn('[GECKO] Country fetch error:', e instanceof Error ? e.message : e); }
        return null;
      })(),
      ...
      (async () => {
        ...
        } catch (e) { console.warn('[GECKO] Wikipedia fetch error:', e instanceof Error ? e.message : e); }
        return null;
      })(),
      ...
      (async () => {
        ...
        } catch (e) { console.warn('[GECKO] Wikidata fetch error:', e instanceof Error ? e.message : e); }
        return null;
      })(),
    ]);
