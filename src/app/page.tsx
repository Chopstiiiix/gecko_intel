        ...
        {showSplash && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative mb-7 z-[2] flex items-center justify-center"
            >
              <img
                src="/gecko-logo.png"
                alt="Gecko Intelligence"
            ...
            <div className="flex items-center gap-[2px] mb-3 z-[2]">
              {'GECKO'.split('').map((letter, i) => (
                <motion.span
                  ...
                  className="gecko-display text-4xl md:text-5xl font-bold tracking-[0.45em]"
